...
```
cd existing_repo
git remote add origin https://git.apuscn.com:8443/Xal-Android/kalina.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.apuscn.com:8443/Xal-Android/kalina/-/settings/integrations)
